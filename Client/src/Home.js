...
Microshading or Powder Brows: Unlike microblading, which creates hair-like strokes, microshading uses a stippling method, which involves repetitive dots of pigment. This technique is similar to the look of eyebrow powder or a soft pencil look, providing a more filled-in appearance. It's often recommended for individuals with oily skin or those who prefer a softer, fuller eyebrow look.
...
Paraffin Pedicure: Involves dipping your feet into warm paraffin wax to deeply moisturize the skin.</li></Card.Text>
  ...
  <Container fluid className='p-2 shadow d-flex justify-content-center align-items-center text-center'>
     ...
     <Row sm={1} md={1} className='mx-auto'>
      ...
      <Row className='col-md-12'><Col>Monday	</Col><Col>Closed</Col></Row>
      <Row className='col-md-12'><Col>Tuesday</Col><Col>	10AM–7PM</Col>




</Row>
      <Row className='col-md-12'><Col>Wednesday</Col><Col>	10AM–7PM</Col></Row>
      <Row className='col-md-12'><Col>Thursday</Col>	<Col>10AM–7PM</Col></Row>
      <Row className='col-md-12'><Col>Friday	</Col><Col>10AM–7PM</Col></Row>
